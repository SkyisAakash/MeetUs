...
S.F.E.N is a branch of Entrepreneurs International Network. Please email the organizer of this group to become an event host if you like to hold local events to for entrepreneurs.", image_url:"")
...
Of course, Food is almost always a part of our hikes, often both during (of course) and after, and we welcome both New and Old Friends!", image_url:"")
...
Learn about Weave Cloud and Weaveworks open source projects, and meet other Weave users to help solve problems.", image_url:"")
