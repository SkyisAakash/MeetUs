  ...
  render() {
    ...
    return (
      ...
      <li className="eachGroup">
        <object data={this.props.group.image_url} type="image/png" className="groupIndexImage"> <img src="https://s26.postimg.cc/7c57ixvuh/image-not-found.jpg" id="grpidximgobj" className="groupIndexImage"/></object>
